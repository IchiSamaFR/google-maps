...
namespace GoogleMapsApi.Engine.JsonConverters
{
    ...
    public class EnumMemberJsonConverterFactory : JsonConverterFactory
    {
        ...
        {
            { typeof(GoogleMapsApi.Entities.AddressValidation.Response.ConfirmationLevel), static () => new EnumMemberJsonConverter<GoogleMapsApi.Entities.AddressValidation.Response.ConfirmationLevel>() },
            { typeof(GoogleMapsApi.Entities.AddressValidation.Response.Granularity), static () => new EnumMemberJsonConverter<GoogleMapsApi.Entities.AddressValidation.Response.Granularity>() },
