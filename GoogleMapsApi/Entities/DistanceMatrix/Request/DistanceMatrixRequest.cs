namespace GoogleMapsApi.Entities.DistanceMatrix.Request
{
    ...
    public class DistanceMatrixRequest : SignableRequest
    {
        ...
        /// - walking requests distance calculation for walking via pedestrian paths and sidewalks (where available).
        /// - bicycling requests distance calculation for bicycling via bicycle paths and preferred streets(where available).
